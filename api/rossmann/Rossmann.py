...
class Rossmann(object):
    def __init__(self):
        self.competition_distance_scaler = pickle.load( open('C:/Users/Criso/repos/rossmann_project/parametros/competition_distance_scaler.pkl', 'rb'))
        self.competition_time_month_scaler = pickle.load( open('C:/Users/Criso/repos/rossmann_project/parametros/competition_time_month_scaler.pkl', 'rb'))
        self.promo_time_week_scaler = pickle.load( open('C:/Users/Criso/repos/rossmann_project/parametros/promo_time_week.pkl', 'rb'))
        self.year_scaler = pickle.load( open('C:/Users/Criso/repos/rossmann_project/parametros/year_scaler.pkl', 'rb'))
        self.store_type_encoder = pickle.load( open('C:/Users/Criso/repos/rossmann_project/parametros/store_type_encoder.pkl', 'rb'))
    ...
    def data_preparation(self, df5):
        ...
        cols_selected = ['store', 'promo', 'store_type', 'assortment', 'competition_distance',
                         ...
                         'promo2_since_year', 'competition_time_month', 'promo_time_week', 'month_cos', 'month_sin',
                         'day_sin', 'day_cos', 'week_of_year_cos', 'week_of_year_sin', 'day_of_week_sin',
                         'day_of_week_cos']

        return df5[cols_selected]

    def get_predition(self, model, original_data, test_data):
